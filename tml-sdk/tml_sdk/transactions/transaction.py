...
class Transaction:
    ...
    def validate(self) -> None:
        ...
        if self.processing_status not in valid_statuses:
            raise TMLValidationError(f"processing_status must be one of {valid_statuses}")
    
    def add_prediction(self, model_id: str, prediction: Any, confidence: float = None) -> None:
        """
