                    ...
                    "spec": {
                        "containers": [{
                            ...
                            "env": [
                                ...
                                {"name": "KAFKA_BOOTSTRAP_SERVERS", "value": "tml-kafka:9092"},
                                {"name": "CASSANDRA_HOSTS", "value": "tml-cassandra"},
                                {"name": "MLFLOW_TRACKING_URI", "value": "http://tml-mlflow:5000"}
                            ],
                            "resources": {
                                "requests": {
                                    "memory": "512Mi",
                ...
                "template": {
                    ...
                    "spec": {
                        "containers": [{
                            ...
                            "image": "tml-platform:latest",
                            "command": ["python", "-m", "tml.ingestion.kafka_consumer"],
                            "env": [
                                {"name": "TML_ENVIRONMENT", "value": "production"},
                                {"name": "KAFKA_BOOTSTRAP_SERVERS", "value": "tml-kafka:9092"},
                                {"name": "REDIS_HOST", "value": "tml-redis"},
