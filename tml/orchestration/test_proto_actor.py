...
class TestTMLActors:
    ...
    async def test_model_actor_creation(self, actor_system):
        ...
        # Create model actor
        model_ref = await actor_system.create_actor(
            ModelActor,
            "model_001"
        )
...
class TestTMLPlatformIntegration:
    ...
    async def test_platform_startup(self):
        ...
        platform = TMLPlatform(TMLPlatformConfig(
...
class TestPerformance:
    ...
    async def test_throughput_performance(self):
        ...
        try:
            ...
            logger.info("Throughput performance test",
    ...
    async def test_latency_performance(self, tml_platform):
        ...
        logger.info("Latency performance test",
                   p50_ms=p50,
                   p95_ms=p95,
                   p99_ms=p99,
