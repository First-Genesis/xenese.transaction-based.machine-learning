        ...
        try:
            with psycopg2.connect(self.connection_string) as conn:
                with conn.cursor() as cursor:
                    ...
                    parameters = {
                        "weights": model_data.get("weights", []).tolist() if hasattr(model_data.get("weights", []), 'tolist') else model_data.get("weights", []),
    ...
    def save_transaction_model(self, transaction_model) -> bool:
        ...
        try:
            ...
            model_data = {
                ...
                "weights": getattr(transaction_model.model, 'weights', []) if hasattr(transaction_model, 'model') else [],
                "bias": getattr(transaction_model.model, 'bias', 0.0) if hasattr(transaction_model, 'model') else 0.0,
                ...
                "x_coord": getattr(transaction_model.context, 'x_coord', 0.0) if hasattr(transaction_model, 'context') else 0.0,
                "y_coord": getattr(transaction_model.context, 'y_coord', 0.0) if hasattr(transaction_model, 'context') else 0.0,
