...
class StreamProcessor:
    ...
    def key_by(self, transaction: Dict) -> str:
        ...
        return transaction.get('model_id', f"model_{transaction.get('transaction_id', 'unknown')}")
    ...
    def _create_state_with_inheritance(self, key: str, transaction: Dict) -> StreamState:
        ...
        try:
            ...
            inheritance_info = self.inheritance_coordinator.process_inheritance(key, context)
                ...
                for future in futures:
                    try:
                        ...
                        if self.processing_stats['transactions_processed'] % 10 == 0:
                            logger.info(f"Processed {self.processing_stats['transactions_processed']} transactions | "
