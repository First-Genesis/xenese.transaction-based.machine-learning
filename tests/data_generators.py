...
class HeatExchangerDataGenerator:
    ...
    def generate_transactions(self, count: int = 100) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            ...
            cold_temp = base_cold_temp + np.random.normal(0, 5) + seasonal_variation * 10
            ...
            transaction = {
                ...
                "physics_parameters": {
                    ...
                    "energy_output": hot_flow * cp_hot * hot_temp_out + cold_flow * cp_cold * cold_temp_out,
        ...
        for i in range(count):
            ...
            transaction = {
                ...
                "physics_parameters": {
                    ...
                    "transaction_amount": amount if transaction_type != 'payment' else -amount,
...
class IoTSensorDataGenerator:
    ...
    def generate_transactions(self, count: int = 100) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            ...
            humidity = base_humidity - (temperature - base_temp) * 1.5 + np.random.normal(0, 5)
            ...
            transaction = {
                ...
                "physics_parameters": {
                    ...
                    "vapor_pressure": 6.112 * math.exp(17.67 * temperature / (temperature + 243.5)),
...
def create_test_datasets() -> List[TestDataset]:
    ...
    flow_violations = sum(1 for t in flow_transactions if t["context"]["physics_violation"])
    ...
    mfg_violations = sum(1 for t in mfg_transactions if t["context"]["physics_violation"])
    ...
    for dataset in datasets:
        ...
        for transaction in dataset.transactions:
            ...
            if isinstance(serializable_transaction["timestamp"], datetime):
                serializable_transaction["timestamp"] = serializable_transaction["timestamp"].isoformat()
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        print(f"- {dataset.name}: {len(dataset.transactions)} transactions, "
