...
class DeviceManager:
    ...
    async def update_device_status(self, device_info: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.logger.error("Failed to update device status",
                            device_id=device_info.get('device_id'),
                            error=str(e))
    ...
    async def _get_device_from_cache(self, device_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error("Failed to get device from cache", 
                            device_id=device_id, error=str(e))
            return None
    
    async def _update_device_cache(self, device_id: str, device_info: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.logger.error("Failed to update device cache", 
                            device_id=device_id, error=str(e))
    ...
    async def _update_telemetry_summary(self, device_id: str) -> None:
        ...
        try:
            ...
            async with self.db_pool.acquire() as conn:
                ...
                ''', device_id, today, datetime.now())
                
        except Exception as e:
            self.logger.error("Failed to update telemetry summary", 
                            device_id=device_id, error=str(e))
