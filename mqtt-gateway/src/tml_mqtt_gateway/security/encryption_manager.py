...
class EncryptionManager:
    ...
    def __init__(self, config: TMLGatewayConfig):
        ...
        self.master_key = os.environ.get('TML_MASTER_KEY', 'default_master_key_change_in_production')
    ...
    def generate_device_key(
        ...
        try:
            ...
            self.logger.info("Generated device encryption key",
                           device_id=device_id,
                           method=method)
            ...
            self.logger.error("Failed to generate device key",
                            device_id=device_id,
                            error=str(e))
            raise
    ...
    def encrypt_message(
        ...
        try:
            ...
            self.logger.error("Failed to encrypt message",
                            device_id=device_id,
                            error=str(e))
            raise
    ...
    def generate_rsa_keypair(
        ...
        try:
            ...
            self.logger.error("Failed to generate RSA key pair",
                            device_id=device_id,
                            error=str(e))
            raise
    ...
    def encrypt_with_public_key(
        ...
        try:
            ...
            self.logger.error("Failed to encrypt with public key",
                            device_id=device_id,
                            error=str(e))
            raise
    ...
    def decrypt_with_private_key(
        ...
        try:
            ...
            self.logger.error("Failed to decrypt with private key",
                            device_id=device_id,
                            error=str(e))
            raise
    ...
    def rotate_device_key(self, device_id: str) -> bytes:
        ...
        try:
            ...
            self.logger.info("Rotated device encryption key",
                           device_id=device_id)
            
            return new_key
            
        except Exception as e:
            self.logger.error("Failed to rotate device key",
                            device_id=device_id,
                            error=str(e))
            raise
    ...
    def check_key_rotation(self) -> List[str]:
        ...
        if devices_needing_rotation:
            self.logger.warning("Devices need key rotation",
