...
class DashboardGenerator:
    ...
    def generate_main_dashboard(self) -> Dict[str, Any]:
        ...
        dashboard["dashboard"]["panels"].append(
            self._create_stat_panel(
                title="Total Devices", metric="db_device_count", x=6, y=19, w=6, h=4
            )
        )
        ...
        dashboard["dashboard"]["panels"].append(
            self._create_timeseries_panel(
                ...
                metrics=["kafka_messages_sent_total", "kafka_send_errors_total"],
                x=0,
                y=24,
                w=12,
                h=6,
    ...
    def generate_security_dashboard(self) -> Dict[str, Any]:
        ...
        dashboard["dashboard"]["panels"].append(
            self._create_timeseries_panel(
                ...
                metrics=["auth_attempts_total", "auth_failures_total"],
                x=0,
                y=1,
                w=12,
                h=6,
    ...
    def _create_table_panel(
        self, title: str, query: str, x: int, y: int, w: int, h: int
    ) -> Dict[str, Any]:
        ...
        panel = {
            ...
            "title": title,
            "gridPos": {"h": h, "w": w, "x": x, "y": y},
            "targets": [{"rawSql": query, "format": "table", "refId": "A"}],
    ...
    def _create_heatmap_panel(
        self, title: str, metric: str, x: int, y: int, w: int, h: int
    ) -> Dict[str, Any]:
    ...
    def export_dashboard(self, dashboard: Dict[str, Any], filename: str) -> None:
        ...
        try:
            ...
            self.logger.error(
                "Failed to export dashboard", filename=filename, error=str(e)
            )
