...
class MQTTMetrics:
    ...
    def __init__(self):
        ...
        self.disconnections_total = Counter(
            ...
            'Total number of MQTT disconnections'
        )
        ...
        self.queue_size = Gauge(
            ...
            'Number of messages in the processing queue'
        )
...
class KafkaMetrics:
    ...
    def __init__(self):
        ...
        self.flush_timeouts = Counter(
            'kafka_flush_timeouts_total',
            'Total number of Kafka flush timeouts'
        )
